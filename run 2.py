#!/usr/bin/env python3
"""
PropEdge V14.0 — Master Orchestrator
======================================
Repo:        git@github.com:iamwerewolf1007/PropEdgeV14.0.git
Working dir: ~/Documents/GitHub/PropEdgeV14.0
...
Commands:
  ...
  python3 run.py predict    — Batch 2: predict today's props  (18:30 UK, default)
  python3 run.py predict 1  — Batch 1: early morning scan     (08:30 UK)
  python3 run.py predict 3  — Batch 3: evening top-up         (20:30 UK)
  python3 run.py predict 4  — Batch 4: late West-Coast tip    (23:30 UK)
...
Batch schedule (launchd agents, UK time):
  08:00 — batch0_grade.py         (grade + retrain)
  08:30 — batch_predict.py 1      (early morning scan)
  18:30 — batch_predict.py 2      (main prediction run)
  20:30 — batch_predict.py 3      (evening top-up)
  23:30 — batch_predict.py 4      (late West-Coast tip)
"""
...
def cmd_setup():
    ...
    print("    08:00 UK → python3 run.py grade    (grade yesterday)")
    print("    08:30 UK → python3 run.py predict  (score today's props)")
    print()
